        ...
        <div className="w-full max-w-screen-lg mx-auto px-4 pt-4 mt-12">
            ...
            <div className='flex flex-col w-full'>
                <div className='w-full'>
                    ...
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>Javascript의 scroll event 기반으로 움직이는 상단 loading bar 컴포넌트입니다. 출시한지 2주만에 300회 이상의 다운로드를 기록하고 있습니다.</span>
                    </div>
                    <div className='pt-4 flex space-x-4'>
                        <a href="https://www.npmjs.com/package/react-scroll-header-loading" target="_blank" rel="noopener noreferrer">
                            <FaNpm className='text-2xl sm:text-3xl' />
                        </a>
                    ...
                    <span className='other-experience-tag ml-2 text-sm sm:text-base'>Frontend 개발</span>
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>Gemini API를 통해 영양제 추천, 영양제 조합을 제공합니다. Frontend 개발을 혼자 담당하였고, 기술환경 세팅, Skeleton loading 구현 등을 4일 동안 개발했습니다.</span>
                    </div>
                    <div className='pt-4 flex space-x-4'>
                    ...
                    <span className='other-experience-tag ml-2 text-sm sm:text-base'>Owner</span>
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>NextJS와 Typescript 기반 저의 이력서 웹을 구현했습니다. Github을 통해 배포를 진행했습니다.</span>
                    </div>
                    <div className='pt-4 flex space-x-4'>
                    ...
                    <span className='other-experience-tag ml-2 text-sm sm:text-base'>Frontend 개발</span>
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>사용자의 코딩 수준, 진행한 프로젝트 등 여러 정보를 AI로 처리하여 회사를 추천합니다. Frontend 개발을 전반적으로 담당하며, 진행 중입니다.</span>
                    </div>
                    <div className='pt-4 flex space-x-4'>
                    ...
                    <span className='other-experience-tag ml-2 text-sm sm:text-base'>졸업예정</span>
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>소프트웨어융합공학과 21학번으로, 2025년 2월 졸업예정입니다.</span>
                    </div>
                    ...
                    <span className='other-experience-tag ml-2 text-sm sm:text-base'>졸업</span>
                    <div className='pt-4'>
                        <span className='text-sm sm:text-md'>2014년도 뉴미디어 솔루션과에 입학한 후 2016년 졸업했습니다. 이후 바로 웹개발자로서 커리어를 시작했습니다.</span>
                    </div>
                    <hr className='mt-8 mb-3'/>
                </div>
            </div>
