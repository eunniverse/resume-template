...
export const WorkExperience = () => {
    return (
        <div className="w-full max-w-screen-lg mx-auto px-4 pt-4 mt-12">
            <h1 className='text-primaryColor font-extrabold text-3xl sm:text-4xl pb-6'>#WORK EXPERIENCE</h1>
            <div className='flex flex-col sm:flex-row w-full'>
                <div className='flex-shrink-0 w-full sm:w-72 mb-4 sm:mb-0'>
                    <div className='pr-0 sm:pr-10 p-1.5'>
                        <div className='text-xl sm:text-3xl font-bold text-right'>피앤피시큐어</div>
                ...
                <div className='flex-grow w-full'>
                    ...
                    <div className='pt-4'>
                        ...
                        <span className='text-sm sm:text-md'>서버 및 DBMS 계정, 명령어 등 권한을 부여받기 위해 신청서를 작성하고, 결재를 제공하는 시스템으로서 Frontend와 Backend 개발을 담당하였습니다. 특히 Frontend의 개발환경과 UX를 개선하기 위해 노력했습니다.</span>
                    </div>
                    <div className='pt-4'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>사용자의 안면정보를 이용해 인증을 하는 시스템으로서 Frontend와 Backend 개발을 담당하였습니다. 특히 API 개선과 실시간 데이터를 명확하게 전달할 수 있는 UI 설계에 중점을 두고 개발했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>사내 OTP를 사용하는 고객사를 관리하기 위한 시스템으로서 Frontend와 Backend 개발을 담당하였습니다. 급히 진행된 일정이었던만큼 NodeJS 기반으로 일주일 만에 개발을 완료했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>인증 시스템에서 사용하는 자사 전용 OTP 생성 모바일 앱으로서 아키텍처 설계, 개발부터 배포까지 혼자 맡아 진행했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>제품 수주, 고객사 관리 등 사내에서 사용하는 영업관리 시스템으로서 Frontend와 Backend 개발을 담당하였습니다. 느린 조회 속도 등 기존에 있던 문제점을 해결하고, Frontend의 기술환경을 개선하기 위해 노력했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
            ...
            <div className='flex flex-col sm:flex-row w-full mt-8'>
                <div className='flex-shrink-0 w-full sm:w-72 mb-4 sm:mb-0'>
                    <div className='pr-0 sm:pr-10 p-1.5'>
                        <div className='text-xl sm:text-3xl font-bold text-right'>케이엘넷</div>
                        <div className='mt-1.5 text-right'>
                            <span>
                                <span className='front-tech-tag'>Frontend</span>
                                <span className='backend-tech-tag ml-1.5'>Backend</span>
                ...
                <div className='flex-grow w-full'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>세금계산서를 웹에서 발행하고, 조회하는 시스템으로 Frontend와 Backend 개발을 개발했습니다. 기본적인 유지보수를 비롯해 비즈니스의 요구에 맞는 다양한 새로운 기능을 개발했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
                    ...
                    <div className='pt-4'>
                        <div className='title-tag'>소개</div>
                        <span className='text-sm sm:text-md'>인턴으로 부여받은 첫 업무로서, IE 브라우저의 Flash 지원 종료에 따라 Flex에서 JSP로 UI를 개선했습니다.</span>
                    </div>
                    <div className='pt-4'>
                        <div className='title-tag'>기여한 부분</div>
                        <ul className='list-disc pl-5'>
